...
export default class LandingMobile extends Component {
    ...
    render() {
        ...
        const aboutLinkMenu = (aboutLinkMenu) =>
            (this.aboutLinkMenu = aboutLinkMenu);
        const workLinkMenu = (workLinkMenu) =>
            (this.workLinkMenu = workLinkMenu);
        const contactLinkMenu = (contactLinkMenu) =>
            (this.contactLinkMenu = contactLinkMenu);
                    ...
                    <div>
                        ...
                        <div className="hamburger-container">
                            ...
                            >
                                ...
                                <img
                                    ref={hexagon}
                                    className="hamburger-hexagon"
                                    src={require('../../Assets/Images/hamburger-hexagon.svg')}
                                />
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            style={{
                                display: this.state.menuOpen ? null : 'none',
                            }}
                        >
                            <p
                                ref={aboutLinkMenu}
                                className="link-mobile-menu"
                                onClick={this.aboutMenuLink}
                            >
                                ABOUT
                            </p>
                            <p
                            ...
                            <Row>
                                <Col lg={12} className="top-section">
                                    ...
                                    >
                                        ...
                                        <h6 className="summary-mobile">
                                            Self-taught AI-first JavaScript
                                            Developer
                                            <br />
                                            (7+ years exp)
                                        </h6>
