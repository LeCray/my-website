...
export default class About extends Component {
    ...
    render() {
        ...
        const aboutLeftCol = (aboutLeftCol) =>
            (this.aboutLeftCol = aboutLeftCol);
                    ...
                    <div style={{ fontFamily: 'Josefin Sans' }}>
                        ...
                        <div className="aboutRightCol">
                            ...
                            >
                                ...
                                <h4>
                                    I am a Mechanical Engineer, and a
                                    self-taught full-stack AI-first JavaScript
                                    Developer
                                </h4>
                                ...
                                <p style={{ textAlign: 'justify' }}>
                                    My development approach is AI-first,
                                    actively working with the latest
                                    cutting-edge AI development tools including
                                    Cline, Cursor, Antigravity, ChatGPT, Claude,
                                    Bolt, n8n, and many more . Mastering these
                                    new AI tools and agentic workflows has
                                    rapidly boosted my development productivity
                                    by more than 10x. Tasks that previously
                                    required a full day can now be completed in
                                    just 10 minutes.
                                </p>
                                ...
                                <div>
                                    ...
                                    <p style={{ textAlign: 'justify' }}>
                                        My passion for internet technology began
                                        alongside my engineering studies,
                                        initially sparked by trading financial
                                        markets and cryptocurrency. This led me
                                        to develop GalxyBit, a cryptocurrency
                                        exchange platform, and co-found
                                        <a
                                            href="https://parkupp.co.za/"
                                            target="_blank"
                                        >
                                            {' '}
                                            Parkupp
                                        </a>
                                        , a decentralized parking app acquired
                                        by Docklands Ventures.
                                        <br />
                                        <br />
                                        I also created Mad-Mobile, a real-time
                                        vehicle diagnostics app, and Money
                                        Calls, a foreign exchange web app.
                                        Later, I founded Paradise Eats, a food
                                        delivery app tailored for towns in South
                                        Africa's Garden Route, successfully
                                        launching the Android applications in
                                        2022.
                                        <br />
                                        <br />
                                        ...
                                        As well as frameworks and technologies
                                        like:
                                        <ul>
                                            <li>React.js</li>
                                            <li>Next.js</li>
                                        ...
                                        <br />
                                        <br />
                                        My final engineering design project
                                        involved a low-cost solar-powered
                                        refrigeration system for rural Africa,
                                        blending my mechanical engineering
                                        skills with my commitment to
                                        sustainability.
                                        <br />
                                        <br />
                                        Previously, I worked on an orbital
                                        launch system for deploying LEO cubesats
                                        aimed at providing affordable high-speed
                                        internet connectivity for the Southern
                                        African Development Community (SADC)
                                        region—a challenging but enriching
