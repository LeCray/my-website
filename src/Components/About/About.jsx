            ...
            <div className="aboutRightCol">
              ...
              >
                ...
                <p style={{ textAlign: "justify" }}>
                  With just one course outstanding, I am currently completing my
                ...
                <p style={{ textAlign: "justify" }}>
                  In my first year of engineering studies, I began learning how
                  to trade the financial markets in my spare time.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  In addition, also in 2018, I co-founded and developed Parkupp,
                  a decentralised parking app that has recently been acquired by
                  ...
                  Garden Route in the Western Cape, SA), and founded Paradise
                  Eats – a food delivery application targetting the towns in the
                  surrounding areas (Uber Eats hasn't offered their services
                  there yet).
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  Beginning of this year, 2023, I returned to Wits to complete
                  the two engineering courses I had due – Solid Mechanics (which
                  I passed), and the Design Project (which I am currently
                  repeating).
                  <br />
                  <br />
