            ...
            <div>
                ...
                <div style={{ fontFamily: 'Josefin Sans' }}>
                            ...
                            <div>
                                ...
                                <div className="work-intra-links">
                                    ...
                                    <p
                                        className="work-link"
                                        onClick={() =>
                                            scrollToComponent(this.medyear, {
                                                offset: -45,
                                                align: 'top',
                                                ease: 'inOutCirc',
                                                duration: 1500,
                                    ...
                                    <p
                                        className="work-link"
                                        onClick={() =>
                                            scrollToComponent(this.research, {
                                                offset: -45,
                                                align: 'top',
                                                ease: 'inOutCirc',
                                                duration: 1500,
                                    ...
                                    <p
                                        className="work-link"
                                        onClick={() =>
                                            scrollToComponent(this.paradise, {
                                                offset: -45,
                                                align: 'top',
                                                ease: 'inOutCirc',
                                                duration: 1500,
                                    ...
                                    <p
                                        className="work-link"
                                        onClick={() =>
                                            scrollToComponent(this.parkupp, {
                                                offset: -45,
                                                align: 'top',
                                                ease: 'inOutCirc',
                                                duration: 1500,
                    ...
                    <div className="work-right-col">
                        <div
                            className="work-right-col-content"
